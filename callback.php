...
define('CONSUMER_KEY', 'YPlyKEYZtslfhheOJbpcfwApA'); // add your app consumer key between single quotes
define('CONSUMER_SECRET', '2i7nREHEztmsKeOlWlqv1L5sAgz9wuULlzIij7wJJ3k0xewJeM'); // add your app consumer secret key between single quotes
define('OAUTH_CALLBACK', 'https://ruchita.github.io/github/ruchita.github.io/callback.php'); // your app callback URL
